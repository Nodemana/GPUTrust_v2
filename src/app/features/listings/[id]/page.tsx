...
import { GPUDetailsCardSkeleton } from './components/GPUDetailsCardSkeleton';
import { GPUMetricsRadar } from './components/GPUMetricsRadar';
import { GPUMetricsCards } from './components/GPUMetricsCards';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {averageMetrics && bestPossibleMetrics && (
              <GPUMetricsRadar 
                gpuMetrics={gpuListing.benchmarkScore}
                averageMetrics={averageMetrics}
                bestPossibleMetrics={bestPossibleMetrics}
              />
            )}
            ...
            <div className="bg-primary dark:bg-primary rounded-lg p-6 shadow-sm border border-stroke dark:border-stroke">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{gpuListing.gpu.gpuArch}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-text-light dark:text-text-light">AIB Partner:</span>
                  <span className="font-medium">{gpuListing.gpu.aib_partner}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-text-light dark:text-text-light">Memory:</span>
                  <span className="font-medium">{gpuListing.gpu.memory}GB {gpuListing.gpu.memoryType}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-text-light dark:text-text-light">Streaming Multiprocessors:</span>
                  <span className="font-medium">{gpuListing.gpu.num_sm}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-text-light dark:text-text-light">CUDA Cores:</span>
                  <span className="font-medium">{gpuListing.gpu.cudaCores}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{gpuListing.benchmarkScore.driverVersion}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-primary dark:bg-primary rounded-lg p-6 shadow-sm border border-stroke dark:border-stroke">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <div className="text-5xl font-sans font-bold text-highlight dark:text-highlight">
                    {gpuListing.price.amount} SOL
                  </div>
                  <div className="text-sm text-text-light dark:text-text-light mt-1">
