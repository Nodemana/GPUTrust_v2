...
export function RelativeRadar({ gpuMetrics, averageMetrics, bestPossibleMetrics }: RelativeRadarProps) {
  ...
  return (
    <div> 
      <div className="h-[40rem] md:h-[40rem]">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Legend align="right" verticalAlign="bottom" wrapperStyle={{ paddingTop: 16 }} />
          </RadarChart>
        </ResponsiveContainer>
      </div>
    </div>
